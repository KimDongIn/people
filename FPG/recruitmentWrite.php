	...
	<div class="sectionSell">
		...
		<div class="boardSell">
			...
			<form id="hireForm"  name="hireForm"  action="recruitmentWrite_update.php" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="img" readonly value="<?echo $member['mb_img']?>"/><?/*기업 로고*/?>
				...
				<span> 채용공고 </span>
					...
					<div class="board01 col-all-8">
						<div class="col-all-12">
							<input type="text" name="subject" id="subject" placeholder="공고제목">
						</div>
						<!--
						<div class="col-all-12">
...
-->
					...
					<div class="imgeBox col-all-4">
						<div id='View_area' class="View_area">
							<img id="prev_View_area" class="obj" src="/upload/comp_img/<?=$member['img']?>"/>
						</div>
						<div>
				...
				<span>상세모집요강</span>
					...
					<div class="col-all-12">
						<textarea name="detailed" rows="16" placeholder="상세모집요강"></textarea>
					</div>
				</div>
				...
				<span>근무시간</span>
					...
					<div class="col-all-12">
						<textarea name="business_time" rows="16" placeholder="근무시간"></textarea>
					</div>
				</div>
				...
				<span>회사복지</span>
					<div class="col-all-12">
						<textarea name="welfare" rows="16" placeholder="회사복지"></textarea>
					</div>
				</div>
				<div>
