				...
				<span> 채용공고 </span>
					...
					<div class="board01 col-all-8">
						<div class="col-all-12">
							<input type="text" name="subject" id="subject" placeholder="공고제목"value="<?=$mb['subject']?>">
						</div>
						<!--
						<div class="col-all-12">
...
-->
					...
					<div class="imgeBox col-all-4">
						<div class="View_area" id='View_area' style="background:none">
							<img id="prev_View_area" class="obj" src="/upload/comp_img/<?=$mb['img']?>"/>
						</div>
						<div>
				...
				<span>회사복지</span>
					<div class="col-all-12">
						<textarea name="welfare" rows="16" placeholder="회사복지"><?=$mb['welfare']?></textarea>
					</div>
				</div>
				<div>
