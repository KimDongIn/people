				...
				<div class="boardForm" style="">
					...
					<div class="imgeBox col-all-4">
						<div id='View_area' style="background:none">
							<img id="prev_View_area" class="obj" src="/upload/comp_img/<?=$mb['img']?>" onerror="this.src='/img/icon.png'" />
						</div>
						<div>
					...
					<div class="col-all-12">
						<input type="text" name="mb_hp" id="reg_mb_hp" placeholder="전화번호(- 없이 숫자만 기입 )" value="<?=$mb['mb_hp']?>">
					</div>
