				...
				<div class="navBox">
					...
					<div class="navSwich">
						<ul>
							...
							<li><a href="/inquiryList.php"><strong>문의하기</strong></a></li>
<!--
		...
		<div class="hideNavBar">
			<div class="contents">
				...
				<ul>
					...
					<!--
					<li><a href="/memberShipTap.php"><strong>회원가입</strong></a></li>
					
					<li><a href="/memberShipIndi.php"><strong>개인회원가입</strong></a></li>
					<li><a href="/memberShipComp.php"><strong>기업회원가입</strong></a></li>
					

					<li><a href="/memberComp.php"><strong>기업회원 정보관리</strong></a></li>
					<li><a href="/memberIndi.php"><strong>개인회원 정보관리</strong></a></li>
