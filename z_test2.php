	...
	<div class="sectionSell">
		...
		<div class="boardSell">
			...
			<div class="boardWrite box1">
				<!--개인회원가입=================================================-->
					<form id="fregisterform" name="fregisterform" action="/gnu/bbs/z_test4.php" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
...
-->
							...
							<div class="col-all-12">
								<input type="text" name="mb_hp" value="" id="reg_mb_hp" placeholder="전화번호(- 없이 숫자만 기입 )">
							</div>
							<!--=====================================-->
...
※ 기타 건의 및 문의사항이 있을 경우 회사 개인정보취급 담당자에게 연락하십시요.<br>
									...
									<input type="checkbox" name="serviceOn"><p>약관동의</p>
								</div>
...
⑤ 회원은 서비스의 이용권한,기타 이용계약상 지위를 타인에게 양도, 증여할 수 없으며, 이를 담보로 제공할 수 없다.<br>
								...
								<span>전체동의</span>
								<div class="termsBox">
									<input type="checkbox" id="allServiceOn"><p>전체 동의</p>
								</div>
							</div>
