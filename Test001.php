...
<input type="hidden" name="oid" value="2021042719400485">
...
-->
<input type="hidden" name="acceptmethod" value="HPP(2):no_receipt:vbank(20210430):below1000:cardpoint">
...
<input type="hidden" name="returnUrl" value="https://peoplecar.kr/yc5/shop/inicis/inistdpay_return.php">
<input type="hidden" name="mKey" value="">
<input type="hidden" name="charset" value="UTF-8">
<input type="hidden" name="payViewType" value="overlay">
<input type="hidden" name="closeUrl" value="https://peoplecar.kr/yc5/shop/inicis/close.php">
<input type="hidden" name="popupUrl" value="https://peoplecar.kr/yc5/shop/inicis/popup.php">
