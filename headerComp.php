		...
		<div class="hideNavBar">
			<div class="contents">
				...
				<ul>
					...
					<li><a href="/myPageIndi.php"><strong>마이페이지 개인</strong></a></li>
				...
				<ul>
					...
					<li><a href="/resumeList.php"><strong>이력서게시판</strong></a></li>
					<li><a href="/recruitmentList.php"><strong>채용게시판</strong></a></li>
				</ul>

				<ul>
					<li><a href="/recruitmentInfo.php"><strong>채용내용</strong></a></li>
					<li><a href="/companyInfo.php"><strong>기업정보</strong></a></li>
					<li><a href="/resumeInfo.php"><strong>이력서 내용</strong></a></li>
