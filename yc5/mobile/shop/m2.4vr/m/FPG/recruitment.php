		...
		<div class="boardSell">
			<form id="hireForm" action="/recruitment_update.php" name="hireForm" method="post" enctype="multipart/form-data">
				...
				<div class="boardForm">
					...
					<span>급여</span>
					<div class="col-all-3">
						<input name="price_chk" class="imgCheckbox" type="checkbox" onClick=checkDisable(this.form) id="18" value="1" <? if($mb['price_chk']==1){echo " checked " ;}?> style="display:none;">
				...
				<div class="boardForm">
					...
					<div class="col-all-12">
						<textarea name="detailed" rows="5" placeholder="상세모집요강"><?=$mb['detailed']?></textarea>
					</div>
				</div>
				...
				<div class="boardForm">
					...
					<div class="col-all-12">
						<textarea name="business_time" rows="5" placeholder="근무시간"><?=$mb['business_time']?></textarea>
					</div>
				</div>
				...
				<div class="boardForm">
					<span>회사지원</span>
					<div class="col-all-12">
						<textarea name="welfare" rows="5" placeholder="회사지원"><?=$mb['welfare']?></textarea>
					</div>
				</div>
				<div>
