	...
	<div class="sectionSell">
		...
		<div class="boardSell">
			<form name="indMembershep" action="/resume_update.php" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="phone1" readonly value="<?echo $member['mb_hp']?>"/><?/*회원이메일*/?>
				...
				<span> 인적사항 </span>
					<div class="board01 col-all-8">
						...
						<div class="col-all-12">
							<!--input type="text" name="career" id="career" placeholder="<?//=$mb['career_year']?>" value="<?//=$mb['career_year']?>"-->
