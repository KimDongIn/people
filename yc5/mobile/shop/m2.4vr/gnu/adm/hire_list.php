...
<form name="fmemberlist" id="fmemberlist" action="/gnu/adm/member_list_update.php" onsubmit="return fmemberlist_submit(this);" method="post">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link('mb_id') ?>채용공고명</a></th>
		<th scope="col" width="150px"><?php echo subject_sort_link('name') ?>회사명</a></th>
		<th scope="col" width="100px"><?php echo subject_sort_link('name') ?>지역</a></th>
		<th scope="col" width="150px">문의전화</a></th>
		<th scope="col" width="200px">모집기간</a></th>
        <th scope="col" width="100px">지원/모집인원</a></th>
