...
<form id="hireForm" action="http://peoplecar.kr/recruitment_update.php" name="hireForm" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="price_chk" onClick=checkDisable(this.form) id="18" value="1"
			<? if($mb['price_chk']==1){echo " checked ";}?>>
