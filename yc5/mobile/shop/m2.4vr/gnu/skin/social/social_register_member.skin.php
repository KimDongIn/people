...
<div class="mbskin" id="register_member">
    ...
    <!-- 새로가입 시작 -->
	<!--    
   <form id="fregisterform" name="fregisterform" action="https://peoplecar.kr/gnu/plugin/social/register_member_update.php" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
   	-->
    ...
    <div class="sns_tbl tbl_wrap">
        ...
        <tr>
        	<th scope="row"><label for="reg_mb_email">회원 종류<strong class="sound_only">필수</strong></label></th>
            
            <td class="labelBox">
				<input type="radio" name="mb_level" value="1" id="mb_level1" class="frm_input email required" size="70" maxlength="100">
            	<label class="radioBtn" for="mb_level1">개인회원</label>

				<input type="radio" name="mb_level" value="2" id="mb_level2" class="frm_input email required" size="70" maxlength="100">            	
            	<label class="radioBtn" for="mb_level2">기업회원</label>
            </td>
        </tr>
		<!--rune 210407 추가 end-->
        </tbody>
    ...
    function fregisterform_submit(f)
    {
		...
		if (!f.input[name=mb_level].checked) {
            alert("회원종류를 선택하셔야 회원가입 하실 수 있습니다.");
            return false;
        }
