	...
	<div class="sectionSell">
		...
		<div class="myDate">
			...
			<div class="myImg">
				...
				<div id='View_area'>
					<?// if(strlen($mb['img']) > 0) {?>
					<img src="/upload/profile/<?=$mb_img?>" onerror="this.src='/img/icon.png'"/>
			...
			<div class="basicInformation">
				...
				<div class="basicInformationTop" style="">
					...
					<!--나의 회원정보 수정-->
					<input type="button" name="" id="btn01" onClick="location.href='/memberIndi.php?no=<?=$member['mb_no']?>'">
					<label for="btn01">
						<img id="cvFormalBtnImg" src="/img/cvFormalButtom.png">
					</label>
					
					<!--이력서 수정-->
					<input type="button" name="" id="btn02" onClick="location.href='./resume.php?no=<?=$member['resume_num']?>'">
					<label for="btn02">
...
-->
		...
		<div class="supportStatus">
			<table>
				...
				<tr class="tableList">
					<td class="row1"><a href="/recruitmentInfo.php?no=<?=$hi['hire_num']?>"><?=$hi['company_name']?></td>
					
					<td class="row2">
						
						<a href="/recruitmentInfo.php?no=<?=$hi['hire_num']?>"><?=$hi['subject']?></a>
						<!-- 파라미터값 넣기
