<section>
	<div class="sectionSell">
		...
		<div class="myDate">
			...
			<div class="myImg">
				<!--이미지-->
				<div id='View_area' onClick="location.href='/company.php'">
					<img src="/upload/comp_img/<? echo $member['mb_profile']?>" />
				</div>
			...
			<div class="basicInformation">
				...
				<div class="basicInformationTop">
					<span>기본정보</span>
					<!-- 회원정보 수정 페이지 -->
					<input type="button" id="cvFormalBtn" onClick="location.href='/memberComp.php'">
					...
					-->
					<!--결제페이지 이동-->
					<input type="button" id="payBtn" onClick="location.href='/yc5/shop/item.php'">
					<label for="payBtn">
		...
		<div class="bestResources">
			<table>
				...
				<tr class="tableList">
					...
					<td class="row4"><?=$mb['price']?></td>
					<td class="row5"><?=$mb['work_s']?></td>
					<td class="row6">
						<a href="/myResomList.php?no=<?=$mb['no']?>">지원현황</a>(<?=$mb['cnt']?>)
						<!--
					...
					<td class="row7">
						<!--채용정보 파라미터값 추가-->
						<a href="/recruitment.php?no=<?=$mb['no']?>">
							<label for="compBtn">
