...
$originPath= $_SERVER['DOCUMENT_ROOT'].'/gnu';
// PATH 는 서버상에서의 절대경로
define('G5_ADMIN_PATH',     $originPath.'/'.G5_ADMIN_DIR);
define('G5_BBS_PATH',       $originPath.'/'.G5_BBS_DIR);
define('G5_DATA_PATH',      $originPath.'/'.G5_DATA_DIR);
define('G5_EXTEND_PATH',    $originPath.'/'.G5_EXTEND_DIR);
define('G5_LIB_PATH',       $originPath.'/'.G5_LIB_DIR);
define('G5_PLUGIN_PATH',    $originPath.'/'.G5_PLUGIN_DIR);
define('G5_SKIN_PATH',      $originPath.'/'.G5_SKIN_DIR);
define('G5_MOBILE_PATH',    $originPath.'/'.G5_MOBILE_DIR);
