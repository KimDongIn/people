...
<!--                    <input type="text" name="od_tel" value="<?php echo get_text($member['mb_tel']); ?>" id="od_tel" required class="frm_input required" maxlength="20">-->
                ...
                <li style="display:none">
                    ...
                    <input type="text" name="od_zip" value="111111" id="od_zip" required class="frm_input required" size="5" maxlength="6">
                    ...
                    <input type="text" name="od_addr1" value="addr1" id="od_addr1" required class="frm_input frm_address required">
                    <label for="od_addr2" class="sound_only">상세주소</label>
                    <input type="text" name="od_addr2" value="addr2" id="od_addr2" class="frm_input frm_address">
                    <label for="od_addr3" class="sound_only">참고항목</label>
                    <input type="text" name="od_addr3" value="addr3" id="od_addr3" class="frm_input frm_address" readonly="readonly">
                ...
                <!-- peopleCar 주문내용 체크-->
                <li style=" padding: 10px; background: #e5e5e5e5;">
                	<input class="oderCk" type="radio" name="ad_sel_addr" value="same" id="ad_sel_addr_same2">
					<label for="ad_sel_addr_same2" style="display: inline;">주문 내용을 확인</label>
                </li>
        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="od_b_tel" id="od_b_tel" required value="010-000-0000" class="frm_input required" maxlength="20">
                </li>
                <li>
                ...
                <li>
                    ...
                    <span class="add_num"><input type="text" name="od_b_zip" value="1111111" id="od_b_zip" required class="frm_input required" size="5" maxlength="6">
                    ...
                    <input type="text" name="od_b_addr1" id="od_b_addr1" value="addr1" required class="frm_input frm_address required">
                    <label for="od_b_addr2" class="sound_only">상세주소</label>
                    <input type="text" name="od_b_addr2" id="od_b_addr2" value="addr2" class="frm_input frm_address">
                    <label for="od_b_addr3" class="sound_only">참고항목</label>
                    <input type="text" name="od_b_addr3" id="od_b_addr3" value="addr3" class="frm_input frm_address" readonly="readonly">
                    <input type="hidden" name="od_b_addr_jibeon" value="">
                </li>
                <li>
                    <label for="od_memo">전하실 말씀</label>
                    <textarea name="od_memo" id="od_memo"><? echo $mb_level ?></textarea>
                </li>
            </ul>
        </div>
    </section>
...
function orderfield_check(f)
{
    ...
    check_field(f.od_b_name, "주문 내용을 확인을 채크해 주세요");
