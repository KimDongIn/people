...
//echo "<script>alert('".$default['de_inicis_lpay_use']."');</script>";
//echo "<script>alert('".$default['de_inicis_kakaopay_use']."');</script>";
if( $default['de_inicis_lpay_use'] || $default['de_inicis_kakaopay_use'] ){   //이니시스 L.pay 사용시
//    echo "<script>alert('".G5_SHOP_PATH.'/inicis/lpay_form.1.php'."');</script>";
...
-->
        ...
        ?>
				...
				<div class="tbl_frm01 tbl_wrap">
					<table>
						<tbody>
							...
							<tr style="display:none;">
								...
								<td>
									...
									<input type="text" name="od_zip" value="111111" id="od_zip" required class="frm_input required" size="8" maxlength="6" placeholder="우편번호">
									...
									<input type="text" name="od_addr1" value="addr1" id="od_addr1" required class="frm_input frm_address required" size="60" placeholder="기본주소">
									<label for="od_addr1" class="sound_only">기본주소<strong class="sound_only"> 필수</strong></label><br>
									<input type="text" name="od_addr2" value="addr2" id="od_addr2" class="frm_input frm_address" size="60" placeholder="상세주소">
									<label for="od_addr2" class="sound_only">상세주소</label>
									<br>
									<input type="text" name="od_addr3" value="addr3" id="od_addr3" class="frm_input frm_address" size="60" readonly="readonly" placeholder="참고항목">
							...
							<tr>
								<!-- peopleCar 주문내용 체크-->
								<th scope="row"><label>주문내용<strong class="sound_only"> 필수</strong></label></th>
								<td>
									<div class="orderCk">
										<input class="oderCk" type="radio" name="ad_sel_addr" value="same" id="ad_sel_addr_same2">
										<label for="ad_sel_addr_same2">주문 내용을 확인</label>
									</div>
								</td>
							</tr>
                        ...
                        ?>
									...
									<input type="text" name="od_hope_date" value="<? echo $mb_level ?>" id="od_hope_date" required class="frm_input required" size="11" maxlength="10" readonly="readonly"> 이후로 배송 바랍니다.
								</td>
							</tr>
							<?php } ?>
						</tbody>
			...
			<!-- 받으시는 분 입력 시작 { -->
			<section id="sod_frm_taker" class="hide">
				<h2>받으시는 분</h2>
...
//				echo "<script>alert('".$mb_level."');</script>";
                ?>
							...
							<tr>
								...
								<td><input type="text" value="관리자" name="od_b_name" id="od_b_name" required class="frm_input required" maxlength="20"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td id="sod_frm_addr">
									...
									<input type="text" name="od_b_zip" value="1111111" id="od_b_zip" required class="frm_input required" size="8" maxlength="6" placeholder="우편번호">
									...
									<input type="text" name="od_b_addr1" value="addr1" id="od_b_addr1" required class="frm_input frm_address required" size="60" placeholder="기본주소">
									<label for="od_b_addr1" class="sound_only">기본주소<strong> 필수</strong></label><br>
									<input type="text" name="od_b_addr2" value="addr2" id="od_b_addr2" class="frm_input frm_address" size="60" placeholder="상세주소">
									<label for="od_b_addr2" class="sound_only">상세주소</label>
									<br>
									<input type="text" name="od_b_addr3" value="addr3" id="od_b_addr3" readonly="readonly" class="frm_input frm_address" size="60" placeholder="참고항목">
							...
							<tr>
								...
								<td><textarea name="od_memo" id="od_memo"><? echo $mb_level ?></textarea></td>
							</tr>
						</tbody>
					</table>
				</div>
...
<script>
	...
	function forderform_check(f) {
		...
		//peopleCar 추가 ==================================================
		//		var orderCk = document.querySelector('input[name="ad_sel_addr"]').checked;
		//		alert( orderCk );
		//		
		//		if (){
		//			alert("추가 했습니다.");
		...
		check_field(f.od_b_tel, "확인을 눌러주세요.");
