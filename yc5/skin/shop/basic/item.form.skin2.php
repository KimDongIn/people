	...
	<section>
		<div class="sectionSell">
			...
			<div class="payList">
				...
				<!-- ================================================================================= -->
				<div class="payBox">
					<form name="fitem" method="post" action="https://peoplecar.kr/yc5/shop/cartupdate.php" onsubmit="return fitem_submit(this);">
	...
	<div class="popupBox" id="popupBox">
		<div class="popupCont">
			...
			<div class="text">
				...
				<p>3.유료서비스 신청 후 “회사”의 사정에 의해 서비스가 취소될 경우</p>
