...
$listSql = " select @ROWNUM := @ROWNUM + 1 AS ROWNUM,
				...
				date_format(a.work_s, '%m-%d') as work_s,
				date_format(a.work_e, '%m-%d') as work_e
				from hire a,
				(select @ROWNUM :=0) r
				where 1=1
				order by wdate desc
	...
	<div class="sectionSell">
		<div class="qukconnect">
			...
			<div class="col col-all-4">
				<a href="/m/recruitmentList.php" alt="채용정보">
					<img src="/img/con1.png" alt="con_img">
				</a>
			</div>

			<div class="col col-all-4">
				<a href="/m/resumeWrite.php" alt="이력서등록">
					<img src="/img/con2.png" alt="con_img">
				</a>
			</div>

			<div class="col col-all-4">
				<a href="/m/myPageIndi.php" alt="나의이력서">
	...
	<div class="sectionSell">
		<div class="listBoard list2">
			<table>
				...
				<tr>
					<td>
						<?=$recruitDate['work_s']?>~<br>
						<?=$recruitDate['work_e']?>
					</td>
					<td href="./recruitmentInfo.php?no=<?=$row['no']?>">
