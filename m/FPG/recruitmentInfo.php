	...
	<div class="sectionSell">
		<div class="boardSell">
			...
			<div class="infoBox">
				...
				<div class="recoLogo">
				<a href="/m/companyInfo.php?mb_id=<?=$hi['mb_id']?>" alt="기업보기" >
					<!--이미지-->
					<? if(strlen($hi['img']) > 0) {?>
				...
				<div class="infoArea">
					...
					<div class="infoData">
						<div>연락처</div>
						<div class="infoBoard"><?=$hi['phone1']?></div>
					</div>
			...
			<form name="indMembershep" action="/m/hire_application.php" method="post" >
