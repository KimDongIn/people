...
//이력서관리 입력정보
$query ="
		SELECT a.no,a.subject,a.mb_id,a.name,a.career_year,a.career_month,a.place1,a.place2,a.place3,a.room,
		a.status, a.phone1, a.email,a.img,a.infomation_use,a.email_use,
...
<form name="indMembershep" action="https://peoplecar.kr/resume_update.php" method="post" enctype="multipart/form-data">
...
<!--            <?php if ($w=='u'){ ?><a href="./boardgroupmember_form.php?mb_id=<?php echo $mb['mb_id'] ?>" class="btn_frmline">접근가능그룹보기</a><?php } ?>-->
    ...
    <tr>
        ...
        <td>
			...
			<select name="wr_6" class="y2" id="selectID2" >
    ...
    <tr>
     ...
     <tr>
        ...
        <td rowspan="4">
            ...
            <label for="imgDelBtn"> 파일 삭제 </label>
        </td>
    </tr>
	<tr>
	</tr>
	...
	<tr>
		...
		<th scope="row"><label for="mb_img">성별</label></th>
		<td>
			<input type="radio" name="sex" value="0" id="mbSex1" <?if($mb['mb_sex'] == 0){ echo " checked";}?> >
            <label for="mbSex1">남</label>
            <input type="radio" name="sex" value="1" id="mbSex2" <?if($mb['mb_sex'] == 1){ echo " checked";}?> >
            <label for="mbSex2">여</label>
		</td>
	</tr>
	<tr>
