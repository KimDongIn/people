...
$mb_company_name	= $_POST['mb_company_name'];
$mb_company_number	= $_POST['mb_company_number'];
//echo "<script>alert('".$company_name."');</script>";
//echo "<script>alert('".$mb_company_name."');</script>";
//echo "<script>alert('".$mb_company_number."');</script>";
...
if ($w == '') {
    $sql = " insert into {$g5['member_table']}
                set mb_id = '{$mb_id}',
                     ...
                     mb_9 = '{$mb_9}',
                     mb_10 = '{$mb_10}',
					 mb_company = '{$mb_company_name}',
					 company_num = '{$mb_company_number}'
					 ";
//	$compsql = 
//
